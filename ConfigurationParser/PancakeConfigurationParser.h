/*
 * PancakeConfigurationParser
 * libconfig fork for Pancake2
 * 2013 Yussuf Khalil
 */
...
#ifndef _PANCAKE_CONFIGURATION_PARSER_H
#define _PANCAKE_CONFIGURATION_PARSER_H
...
#define CONFIG_TYPE_VARIABLE 9

#define CONFIG_OP_SET 0
#define CONFIG_OP_IF_EQUAL 1
#define CONFIG_OP_IF_NOT_EQUAL 2
#define CONFIG_OP_IF_STARTS_WITH 3
#define CONFIG_OP_IF_CONTAINS 4
#define CONFIG_OP_IF_ENDS_WITH 5
#define CONFIG_OP_APPEND 6
#define CONFIG_OP_PREPEND 7
#define CONFIG_OP_CALL 8
