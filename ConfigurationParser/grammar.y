...
%token TOK_EQUALS TOK_NEWLINE TOK_ARRAY_START TOK_ARRAY_END TOK_LIST_START TOK_LIST_END TOK_COMMA TOK_GROUP_START TOK_GROUP_END TOK_SEMICOLON TOK_GARBAGE TOK_ERROR TOK_IF_EQUAL TOK_IF_NOT_EQUAL TOK_IF_STARTS_WITH TOK_IF_CONTAINS TOK_IF_ENDS_WITH TOK_APPEND TOK_PREPEND
...
operator:
  ...
  | TOK_IF_CONTAINS { ctx->setting->op = CONFIG_OP_IF_CONTAINS; }
